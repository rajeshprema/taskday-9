        ...
        results += `
            <div class="card mb-3">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img src="${anime.coverImage.medium}" class="card-img" alt="${
          anime.title.romaji
        }">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text"><strong>Genres:</strong> ${anime.genres.join(
                      ", "
                    )}</p>
                    <p class="card-text"><strong>Average Score:</strong> ${
                      anime.averageScore
                    }</p>
                  </div>
                </div>
